...
function hackeryou_styles(){
	...
	wp_enqueue_style('googlefonts', 'https://fonts.googleapis.com/css?family=Cuprum:400,700|Pacifico');
...
function hackeryou_scripts() {
  ...
  wp_enqueue_script(
    'flickity', //handle
    "http" . ($_SERVER['SERVER_PORT'] == 443 ? "s" : "") . "://unpkg.com/flickity@2.0/dist/flickity.pkgd.min.js",
    false, //dependencies
    null, // version number
    true //load in footer
  );
...
// remove height and width attributes from inserted images
